<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('livecontrols::general.add_type', ['type' => __('livecontrols::admin.user_group')]) }}
        </h2>
    </x-slot>
        ...
        <div class="row justify-content-center my-5">
            <div class="col-sm-12 col-md-8 col-lg-5 my-4">
                <div class="card shadow-sm px-1 mx-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('livecontrols.admin.usergroups.store') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                <x-jet-label value="{{ __('livecontrols::general.color') }}" /><br>
