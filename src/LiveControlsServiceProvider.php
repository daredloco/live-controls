...
use Helvetiapps\LiveControls\Http\Livewire\Images\ImageGallery;
...
use Helvetiapps\LiveControls\Http\Middleware\Analytics\Analyzer;
...
class LiveControlsServiceProvider extends ServiceProvider
{
  ...
  public function boot()
  {
    ...
    Livewire::component('livecontrols-image-gallery', ImageGallery::class);
    ...
    if ($this->app->runningInConsole())
    {
      ...
      $this->publishes([
        __DIR__.'/../resources/views/livewire/images' => resource_path('views/vendor/livecontrols/imagegallery')
      ], 'livecontrols-imagegallery');
    }
  }
}
